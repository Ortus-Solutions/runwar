 ...
 */
public class EqualsPredicateNoCase implements Predicate {

    private final ExchangeAttribute[] attributes;

    EqualsPredicateNoCase(final ExchangeAttribute[] attributes) {
    ...
    public boolean resolve(final HttpServerExchange value) {
        ...
        for(int i = 1; i < attributes.length; ++i) {
            ...
            if(first == null) {
                ...
                return false;
            } else if(!first.equalsIgnoreCase(current)) {
                return false;
            }
        }
        return true;
    ...
    public String toString() {
        return "equals-nocase( {" +  Arrays.asList( attributes ).stream().map(a->a.toString()).collect(Collectors.joining(", ")) + "} )";
    }
    ...
    public static class Builder implements PredicateBuilder {
        ...
        public Predicate build(final Map<String, Object> config) {
            ...
            return new EqualsPredicateNoCase(value);
        }
    }
}
